    ...
    return (
        <section id={id} className="min-h-screen   bg-gradient-to-br from-[#f5ebe0] via-[#e8dcc6] to-[#d6ccc2] relative overflow-hidden">
            <div className='flex flex-col max-w-7xl mx-auto px-6 py-20 gap-2 items-start'>
                ...
                {/* Section Heading */}
                <div className="  px-12 pt-12 pb-16 max-[760px]:px-4 max-[760px]:pt-12 max-[760px]:pb-8 animate-fade-in-up relative z-10">
                    <div className="text-center">
                        {/* Subtitle */}
                        <p className="text-2xl text-center eb-garamond-600-italic text-[#666] font-medium tracking-wide mb-8 animate-fade-in animation-delay-200 max-[760px]:text-base max-[760px]:mb-8">
                            Excellence in Legal Practice
                        </p>

                        {/* Main Title */}
                        <h1 className="text-7xl font-semibold text-[#2c2c2c] text-center leading-tight tracking-tight mb-6 max-[760px]:text-4xl max-[760px]:mb-4 animate-slide-in-down">
                            MEET OUR TEAM
                        </h1>
                        ...
                        {/* Description */}
                        <p className="text-xl text-[#666] max-w-5xl mx-auto leading-relaxed text-justify font-normal animate-fade-in animation-delay-500 max-[760px]:text-base max-[760px]:px-2 max-[760px]:text-justify max-[760px]:max-w-full">
